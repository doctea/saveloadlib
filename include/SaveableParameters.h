// SaveableParameters.h
// the code here is my original work.  hoping that the copilot-suggested code in save_hierarchy.h is useful as a reference implementation for a more fully-featured save/load library
